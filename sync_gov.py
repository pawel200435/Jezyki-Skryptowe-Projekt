...
from scraper.gov_scraper import scrape_gov_data
...
def sync_warnings_to_db():
    """
       Fetches the archive warnings from the GIS gov site, parses the HTML,
       and inserts new records into the database.
       """
    print("Fetching archival warnings from GIS gov site...")

    scraped_data = scrape_gov_data()
    if not scraped_data:
